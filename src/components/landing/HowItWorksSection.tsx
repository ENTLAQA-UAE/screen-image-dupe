  ...
  return (
    <section id="how-it-works" className="py-24 bg-primary relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-0 right-0 w-1/3 h-96 bg-cta/5 rounded-full blur-3xl" />
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="hidden lg:block absolute top-24 left-16 right-16 h-0.5 bg-gradient-to-r from-accent/50 via-cta/50 to-accent/50" />
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {steps.map((step, index) => (
              ...
              >
                {/* Step Number */}
                <div className="relative z-10 w-12 h-12 rounded-full gradient-primary flex items-center justify-center mb-6 shadow-glow">
                  <step.icon className="w-5 h-5 text-primary-foreground" />
                </div>

                {/* Step Label */}
                <span className="text-accent font-display text-sm tracking-wider mb-2 block">
                  STEP {step.step}
                </span>
